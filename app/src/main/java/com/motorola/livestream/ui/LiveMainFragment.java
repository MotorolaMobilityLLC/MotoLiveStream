...
import com.motorola.livestreamlib.model.fb.Comment;
import com.motorola.livestreamlib.model.fb.Cursors;
import com.motorola.livestreamlib.model.fb.LiveInfo;
import com.motorola.livestreamlib.model.fb.LiveViews;
import com.motorola.livestreamlib.model.fb.Reaction;
import com.motorola.livestreamlib.model.fb.User;
import com.motorola.livestreamlib.ui.adapter.CommentListAdapter;
import com.motorola.livestreamlib.ui.animate.ReactionView;
import com.motorola.livestreamlib.ui.privacy.TimelineActivity;
import com.motorola.livestreamlib.util.CircleTransform;
import com.motorola.livestreamlib.util.FbUtil;
import com.motorola.livestreamlib.util.FbUtil.OnDataRetrievedListener;
import com.motorola.livestreamlib.util.FbUtil.OnPagedListRetrievedListener;
import com.motorola.livestreamlib.ui.widget.LiveCountingTimer;
import com.motorola.livestreamlib.util.Log;
import com.motorola.livestreamlib.util.ModHelper;
import com.motorola.livestreamlib.util.SettingsPref;
import com.motorola.livestreamlib.util.Util;
import com.motorola.livestreamlib.viewcache.ViewCacheManager;
import com.motorola.livestreamlib.viewcache.fb.LiveInfoCacheBean;
import com.motorola.livestreamlib.viewcache.fb.TimelinePrivacyCacheBean;
...
//        startUpdateInteractInfo();
    ...
    private void logoutFromFacebook(boolean switchAccount) {
        ...
        FbUtil.deAuthorize(new OnDataRetrievedListener<Boolean>() {
            ...
            public void onSuccess(Boolean data) {
                ...
                if (switchAccount) {
                    getActivity().startActivity(new Intent(getActivity(), com.motorola.livestreamlib.ui.MainActivity.class));
                }
                getActivity().finish();
            }
    ...
    private void startOpensourceLicense() {
        Intent intent = new Intent("com.motorola.livestream.intent.ACTION_CREATE_LICENSE_MENU");
